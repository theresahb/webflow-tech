            ...
            <div className="">
                <form action="" method="get" className='flex flex-col gap-8 p-8 rounded-xl bg-secondaryColor'>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <button type="submit" 
                            className='text-white bg-primaryColor font-medium w-fit px-8 py-4 rounded-full transition ease-linear duration-500 delay-200 hover:text-white hover:bg-primaryColor'>
                            Send
                        </button>
                    </div>
                </form>
