    ...
    return (
        <section>
            <div className="flex justify-start items-start px-4 py-32 w-full sx:px-4 sx:flex-col sm:px-4 sm:flex-col md:px-4 md:flex-col lg:flex-row lg:px-14">
                <div className="flex flex-col gap-8 py-24 sx:w-full md:w-[70%] lg:w-[40%]">
                    <div className="bg-[#8000ff21] px-4 py-2 w-fit rounded">
                        <h3 className='text-primaryColor font-semibold'>FAQ</h3>
                    </div>
                    <div className="flex flex-col gap-6 sm:pr-0 md:pr-40">
                        <h1 className='sx:text-2xl sm:text-4xl md:text-5xl text-secondaryColor font-bold'>
                            The most common questions
                        </h1>
                    </div>
                </div>
                <div className="flex flex-col gap-4 justify-center items-center sx:w-full lg:w-[60%]">
