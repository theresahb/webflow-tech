                ...
                <div className="sm:static md:relative">
                    <div className="">
                        <div className="sm:flex sm:flex-col sm:w-full md:justify-start md:items-start">
                            <div className="flex flex-col gap-8 pl-4 sx:py-8 sx:w-full sx:justify-center sx:items-center sx:text-center sx:pl-0 sx:px-4 md:py-24 md:justify-start md:items-start md:text-start md:pl-4 md:w-[60%] lg:pl-14 lg:w-[70%]">
                                ...
                                <div className="sx:flex sx:flex-col gap-6 sx:my-0 sx:mx-auto sx:justify-center sx:items-center sx:pr-0 md:pr-40 md:mx-0 md:justify-start md:items-start">
                                    ...
                                    <p className="text-paragraphGray font-medium px-1 sx:w-full md:w-[80%]">
